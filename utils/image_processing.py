"""
Image processing utilities for ChemVLM
"""
...
def find_closest_aspect_ratio(aspect_ratio: float, target_ratios: set, 
...
def dynamic_preprocess(image: Image.Image, min_num: int = 1, max_num: int = 6, 
    ...
    """Dynamic image preprocessing for ChemVLM"""
...
def load_image_chemvlm(image_file: str, input_size: int = 448, max_num: int = 6) -> torch.Tensor:
